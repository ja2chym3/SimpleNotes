...
2. Kolik $dm^3$ oxidu uhličitého vznikne při rozkladu $31 \space g$ kyseliny uhličité?
$\ce {H2CO3 -> H2O + CO2}$
...
$\ce {CaCO3 -> CaO + CO2}$
10.  Kolik $dm^3$ jódu můžeme získat, jestliže vytěsníme všechen jód z 30 g jodidu sodného pomocí chloru, a jaké je minimální množství chloru (v $dm^3$) k vytěsnění veškerého jódu?
$\ce {NaI + Cl2 -> NaCl + I2}$
...
| $CuSO_4 \cdot 5 H_2O$ | *pentahydrát síranu měďnatého* | trihydrát bromistanu draselného | $KBrO_4 \cdot 3 H_2O$ |
...
- Oxidy $- \ce {O^{-II}}$
    ...
    - Podle reaktivnosti:
	    ...
	    1.  **Kyselinotvorné** : s vodou tvoří kyslíkatou kyselinu. Jsou to oxidy kovů s oxidačním číslem vyšším než V. Např:  
        $\ce {SO3 + H2O -> H2SO4}$  
...
Slouží k dočištění odpadních vod, především k odstranění fosforu. Dochází zde i ke snížení obsahu dusíku a fosforu jejich zabudováním
...
**Selen** je polovodič, slouží k výrobě fotočlánků, a jako doplněk stravy.
...
- Výroba zápalek (na škrtacích plochách zápalkových krabiček)
...
- Typicky pevné látky (kromě Hg) s kovovým leskem.
- Vedou dobře teplo a elektrický proud, díky elektronovému plynu.
- Jsou kujné a tažné (umožňují to dislokace/nepravidelnost v mřížce, které prostupují mřížkou a mohou se pohybovat).
- Podle počtu nepárových elektronů v kovové vazbě se mění jejich fyzikální vlastnosti – většinou mají velkou hustotu, vysokou teplotu tání a varu, velkou tvrdost a mechanickou pevnost (zejména ve slitinách – látky s proměnným poměrem složek).
- Výjimkou jsou Zn, Cd, Hg, které mají úplně zaplněný (n-1)d orbital, takže jsou měkké a mají nižší body tání a varu (Hg je kapalná) a s-prvky (kvůli nízkému počtu valenčních elektronů).
- Některé kovy mohou mít katalytické účinky (Pt, Pd, Fe).

## Elektrochemická řada napětí kovů (Beketovova řada kovů)

Jedná se o řadu kovů (těch nejdůležitějších) podle stoupajících hodnot standardních elektrodových potenciálů, $E^0$ (jedná se o veličinu, která za standardních podmínek (dané teploty a tlaku) udává měřitelné elektrické napětí mezi vodíkovou elektrodou a elektrodou daného redoxního páru). Jednodušeji: řada je sestavena podle chování kovů ve vodném prostředí a podle jejich schopnosti tvořit kationty (oxidovat se). Kovy stojící v řadě nalevo od vodíku se nazývají kovy neušlechtilé, kovy stojící napravo jsou kovy ušlechtilé.

***Li K Ba Sr Ca Na Mg Al Mn Zn Cr Fe Co Ni Sn Pb H Cu Ag Hg Pt Au***
Li 1; K 1; Ba 2; Sr 2; Ca 2; Na 1; Mg 2; Al 3; Mn 2, 4, 7; Zn 2; Cr 3, 6;  Fe 2, 3;  Co 2, 3; Ni 2; Sn 4; Pb 2; Cu 2; Ag 1; Hg 1, 2; Pt 2, 4; Au 1, 3;

Vlastnosti spojené s Beketovovou řadou:
- Neušlechtilé kovy mají $E^0 < 0$, snadno tvoří kationty.
- Redukční schopnosti prvků klesají v řadě směrem zleva doprava. Prvek stojící v řadě vlevo tedy působí jako redukční činidlo na ionty prvků stojících od něj napravo. To znamená, že kovy stojící v řadě více vlevo mohou vytěsnit kovy stojící od nich napravo z roztoků jejich iontů: $\ce {Fe(s) + CuSO4 (aq) -> FeSO4 (aq) + Cu(s)}$
- Pouze kovy, které jsou od vodíku nalevo, jsou schopny jej vytěsnit z kyselin: $\ce {Zn + 2 HCl -> H2 + ZnCl2}$
- Kationty kovů stojících od vodíku napravo mají schopnost zoxidovat vodík. Vodík tak
redukuje kationty ušlechtilých kovů na elementární kov: $\ce {CuO + H2 -> Cu + H2O}$
- Z leva doprava klesá reaktivita kovů vůči vodě a kyselinám.
- Ušlechtilé kovy reagují pouze s kyselinami se silnými oxidačními účinky: Cu, Ag, Hg
reagují s $\ce {HNO3}$ nebo s $\ce {H2SO4}$, při těchto reakcích ale nevzniká vodík, nevytlačí jej, Au a Pt reagují pouze s lučavkou královskou.

### Cvičení – urči, které reakce proběhnou a zapiš jejich průběh:

Li 1; K 1; Ba 2; Sr 2; Ca 2; Na 1; Mg 2; Al 3; Mn 2, 4, 7; Zn 2; Cr 3, 6;  Fe 2, 3;  Co 2, 3; Ni 2; Sn 4; Pb 2; Cu 2; Ag 1; Hg 1, 2; Pt 2, 4; Au 1, 3;

1) $\ce{Ag2O + H2 -> H2O + 2 Ag}$
2) $\ce{2 Cr + 6 HCl -> 3 H2 + 2 CrCl3}$ 
3) $\ce{Zn + Pb(NO3)2 -> Zn(NO3)2 + Pb}$
4) $\ce{3 Sn + 2 Cr2(SO4)3}$ nereaguje
5) $\ce{Cu + HCl}$ nereaguje
6) $\ce{2 Cr + 3 NiSO4 -> Cr2(NiSO4)3 + 3 Ni}$
7) $\ce{4 Na + SnCl4 -> 4 NaCl + Sn}$
8) $\ce{2 Al + 3 H2SO4 -> 3 H2 + Al2(SO4)3}$
9) $\ce{SrO + H2}$ nereaguje
10) $\ce{Cu + 2 AgNO3 -> Cu(AgNO3)2 + 2 Ag}$
11) $\ce{Mg + CaO}$ nereaguje
12) $\ce{Ca + H2CO3 -> H2 + CaCO3}$
13) $\ce{Mn + BaSO4}$ nereaguje

Beketovova řada tedy popisuje redoxní děje spojené s kovy. Ty se využívají při elektrolýze
a v galvanickém a palivovém článku.

## Elektrolýza

Jedná se o elektrochemický děj, při kterém dochází k látkovým změnám v elektrolytu, vlivem
průchodu stejnosměrného elektrického proudu Vysvětlení pojmů spojených s elektrolýzou:

- Elektrický proud – je proud elektronů protékající uzavřeným elektrickým obvodem.
- Stejnosměrný elektrický proud – protéká elektrickým obvodem jedním směrem a má konstantní velikost a směr.
- Elektrolyt – roztok nebo tavenina iontové sloučeniny, která prostřednictvím volných iontů vede elektrický proud.
- Elektroda – elektrický vodič, který je v kontaktu s elektrolytem.
- Elektrolyzér – zařízení, ve kterém dochází k elektrolýze. Skládá se z elektrolytu a dvou elektrod (katody a anody).
- Katoda – elektroda, na které dochází k redukci (jsou k ní přitahovány kationty), při elektrolýze má záporný náboj.
- Anoda – elektroda, na které dochází k oxidaci (jsou k ní přitahovány anionty), při elektrolýze má kladný náboj.
- Elektrolytická vodivost – je schopnosti iontů elektrolytu přenášet elektrický náboj.
...
- Výroba chemických prvků, především kovů (Na, K, Ca, Mg, Al), ale i nekovů ($\ce {O2}$, $\ce {H2}$, $\ce {Cl2}$, $\ce {F2}$).
- Výroba sloučenin ($\ce {NaOH}$, $\ce {KOH}$).
- Elektrolytická rafinace (čištění) kovů (Al, Cu).
- Galvanické pokovování, kterým se vytváří vrstva kovu na daném objektu (pochromování, poniklování, pomědění, pozinkování).
- Galvanoplastika – metoda podobná pokovování, kde se ale tvoří vrstvy v řádu několika mm. Má široké využití (vinylové desky, CD, DVD, nástroje a formy ve strojírenství, součásti elektronek, zrcadla, formy ve sklářském průmyslu nebo gumárenství).
- Polarografie – analytická metoda, která umožňuje důkazy i stanovení oxidovatelných či redukovatelných látek v roztoku (sledujeme závislost proudu na napětí vkládaném na článek, který je sestaven z jedné polarizovatelné a jedné nepolarizovatelné elektrody ponořené do analyzovaného roztoku).
...
- Sekundární galvanický článek (akumulátor) – takový článek je možné znovu nabít (při tomto procesu dochází k elektrolýze), při následném vybíjení pak poskytuje elektrickou energii. Chemické děje jsou tedy vratné a akumulátory můžeme použít opakovaně.


## Palivové články

Jedná se o zařízení, které převádí chemickou energii paliva na elektřinu. Na rozdíl od akumulátoru
se do něj reaktanty neustále přivádějí a produkty reakce kontinuálně odvádějí. Palivem je obvykle
vodík (lze použít také methanol a uhlovodíky), který je přiváděn na anodu, kde odevzdává svůj
valenční elektron (vodík se oxiduje na $\ce {H+}$). Jako okysličovadlo se používá kyslík, který je přiváděn na záporně nabitou katodu, kde se redukuje za vzniku oxidových aniontů $\ce {O2–}$. V elektrolytu (např. roztoku $\ce {KOH}$) mezi oběma elektrodami dochází k reakci obou iontů za vzniku vody: $\ce {2 H+ + O_2^- -> H2O}$. Nevýhody: vysoká technická náročnost a investiční náklady. Problémový provoz kvůli vysoké teplotě. Výhody: vysoká účinnost (70 %), nízké emise, malá poruchovost a nehlučný provoz. Aplikace: záložní zdroje v nemocnicích a armádních zařízeních, velký rozmach v dopravě (osobní automobily na vodíkový pohon), také byly použity pro vesmírný program Apollo.

## Koroze

Podstatou koroze je samovolná reakce kovů s látkami nacházejícími se v jejich prostředí vedoucí ke znehodnocení daného kovu. (Kovy se tak vracejí do podoby, ve které je můžeme najít v přírodě – např. oxidy).
Odolnost kovů proti korozi (při styku s vodou a vzduchem):

- Kovy odolné proti korozi: tyto kovy korozi nepodléhají (Ti, Cr, Co, Ag, Hg, Pt a Au – většina ušlechtilých kovů).
- Kovy, které se pasivují: tyto kovy se pokrývají ochrannou vrstvičkou oxidačních produktů,
která brání další reakci (Mg, Al, Mn, Zn, Ni, Sn, Pb, Cu).
- Kovy podléhající korozi: tyto kovy reagují se vzduchem nebo vodou, dokud nejsou zcela přeměněny (Li, K, Ba, Sr, Ca, Na, Fe – především s-prvky, proto je nutné alkalické kovy uchovávat pod vrstvou petroleje).

Typy koroze podle mechanismu:

- Koroze chemická: jejím principem je chemická reakce kovu s jinou látkou (může se jednat o kyseliny, vodu, nebo o  látky obsažené ve vzduchu). Na reakci nemá vliv, jestli se nachází ve vodivém nebo nevodivém prostředí.
- Koroze elektrochemická (fyzikálně-chemická): probíhá v elektricky vodivém prostředí. Příčinou koroze je tvorba korozního galvanického článku. Vznikne vodivé spojení mezi látkou, která vystupuje jako anoda, a látkou, která je katodou. Materiál, který je v článku anodou, se oxiduje a tedy koroduje. Korozní galvanický článek vznikne také spojením dvou různých kovů ve vodivém prostředí (proto nelze upevňovat měděný plech ocelovými vruty nebo nýty).

Způsoby ochrany kovů před korozí (principem je především zabránit přístupu vzduchu a vlhkosti ke kovu):

- Provedením ochranných nátěrů barvami.
- Opatřením povrchu smalty.
- Úpravou povrchu kovu naolejováním či namazáním vazelínou – nepolární látky odpuzují vodu.
- Pokrytím povrchu kovu plasty nebo pryží.
- Galvanickým pokovováním – elektrolytické pokrytí povrchu kovu vrstvičkou nekorozivního kovu, např. niklem, chromem, zinkem, cínem.
- Legováním oceli niklem či kobaltem (kovy přidávané do slitin se obecně nazývají legury, legování je přidávání jiného kovu do směsy).
...
Prvky: C, Si, Ge, Sn, Pb
	 -becná elektronová konfigurace:
Charakteristika:

- Pevné skupenství
- Kovový charakter: C a Si jsou nekovy, Ge je polokov a Sn a Pb jsou kovy
- Jejich rozdílná struktura vede k rozdílným vlastnostem

## Cín, 50Sn

### Výskyt v přírodě:

- Nejčastěji ve sloučeninách (kasiterit (cínovec) $\ce{SnO2}$)

### Vlastnosti:

- Stříbrolesklý, tažný kov (tenká fólie je staniol), odolný proti vodě, kyselinám a zásadám

### Výroba:
- Redukcí oxidu cíničitého uhlím: $\ce{SnO2 + 2 C -> Sn + 2 CO}$

### Využití:

- Výroba pájek.
- Nezávadný kov pro styk s potravinami (pokovování vnitřního povrchu konzerv, kotlů a trubek používaných v potravinářském průmyslu).
- Výroba slitin (bronz: měď + cín).
- Ochrana ostatních kovů proti korozi (Fe, Cu a Pb).
- SnO2 se používá při výrobě smaltů.

### Sloučeniny:

- Stabilní jsou sloučeniny s oxidačním číslem IV (existují i II).

## Olovo, $\ce{_{82}Pb}$

### Výskyt v přírodě

- Nejčastěji ve sloučeninách (galenit $\ce{PbS}$).

### Vlastnosti

- Šedý, měkký kov, na vzduchu se pokrývá oxidem olovnatým (ochrana před další oxidací), rozpouští ho kyselina dusičná, odolné proti zředěným kyselinám.

### Výroba

- Pražením galenitu na oxid olovnatý a jeho následnou redukcí uhlíkem:
$\ce{2 PbS + 3 O2 -> 2 PbO + 2 SO2}$
$\ce{PbO + C -> Pb + CO}$

### Využití:

- Stínění rentgenového záření (pokrytí zdí, olověné vesty).
- Výroba střel (vysoká průraznost).
- Klempířské práce (olověné pláty se používají k oplechování komínů).
- Využití olova je omezeno jeho toxicitou (zákaz olovnatého benzínu, problémová likvidace baterií, dříve v barvách nebo při pájení konzerv).

### Sloučeniny

- Všechny jsou jedovaté.
- Stabilní II (existuje i IV, ale má oxidační vlastnosti, snaží se dostat na II).

## 13. skupina (triely, prvky $p^1$)

Prvky: B, Al, Ga, In, Tl
Obecná elektronová konfigurace: $ns^2 \space np^1$
Charakteristika:
...
- Pouze vázaný:
	 - Hlinitokřemičitany: živce, slídy, součásti jílů a hlíny
	 - Bauxit: hydráty oxidu hlinitého, bez vody se jedná o korund
	 - Kryolit: $\ce{Na3[AlF6]}$ hexafluorohlinitan sodný
	 - Korund: $\ce{Al2O3}$ (9 na stupnici tvrdosti)
- Třetí nejrozšířenější prvek zemské kůry se 7,5 %, hlavně díky hlinitokřemičitanů

### Vlastnosti

- Stříbrobílý, lehký, kujný, tažný kov.
- Tepelně i elektricky vodivý.
- Vůči vzduchu a vodě je stálý (díky vrstvě oxidu a hydroxidu), nepodléhá tak korozi.
- Je amfoterní tzn. reaguje jako kyselina i zásada:
	 - Reakce s kyselinami: $\ce{2 Al + 6 HCl -> 2 AlCl3 + 3 H2}$ (s koncentrovanou kyselinou dusičnou se pasivuje), vznikají hlinité soli.
	 - Reakce s hydroxidy: $\ce{2 Al + 2 NaOH + 6 H2O -> 2 Na[Al(OH)4] + 3 H2}$, vznikají hydroxohlinitany.
- Má redukční vlastnosti, které se uplatňují např. u aluminotermie – jedná se o silně
exotermickou reakci kovového hliníku s oxidem kovu – touto reakcí vzniká daný kov a
$\ce{Al2O3}$, typickým příkladem je: $\ce{Al + Fe2O3 -> Fe + Al2O3}$ (směs $\ce{Al}$ a $\ce{Fe2O3}$ v poměru 1:3 se označuje jako termit a lze ji použít ke svažování kolejnic).
- Na vzduchu hoří intenzivním svítivým plamenem: $\ce{4 Al + 3 O2 -> 2 Al2O3}$
- Může být až šestivazný (v komplexech jako je kryolit).
- Má nízkou elektronegativitu a tvoří tak silně polární kovalentní vazby.

### Výroba

- Elektrolýzou taveniny oxidu hlinitého (ve formě bauxitu) s přidaným kryolitem (funguje
jako tavidlo) při teplotě 950 °C.

### Využití

### Sloučeniny

- Halogenidy hlinité – nejdůležitější je fluorid hlinitý $\ce{AlF3}$, který je netěkavý, nerozpustný
a s kovy tvoří fluorohlinitany $\ce{M3I[AlF6]}$, např. kryolit.
- Oxidy – oxid hlinitý $\ce{Al2O3}$: v přírodě se vyskytuje jako korund (tvrdý, těžko tavitelný
minerál), je možné ho připravit spalováním hliníku, je nerozpustný ve vodě a je amfoterní
(reaguje s kyselinami i hydroxidy), má barevné odrůdy.
- Hydroxidy – hydroxid hlinitý $\ce{Al(OH)3}$: je amfoterní:
	 - $\ce{2 Al(OH)3 + 3 H2SO4 -> Al2(SO4)3 + 6 H2O}$ tvoří s kyselinami hlinité soli.
	 - $\ce{Al(OH)3 + NaOH -> Na[Al(OH)4]}$ a s hydroxidy hydroxohlinitany.
